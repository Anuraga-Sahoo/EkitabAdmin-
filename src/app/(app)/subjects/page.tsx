...
import { Loader2, Save, Edit, Trash2, XCircle, BookText } from "lucide-react";
...
export default function ManageSubjectsPage() {
  ...
  const entityApiPrefix = "subjects";
  const entityIcon = BookText;
  ...
  const handleEditClick = (item: SubjectItem) => {
