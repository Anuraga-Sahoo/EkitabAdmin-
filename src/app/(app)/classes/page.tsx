...
import { Loader2, Save, Edit, Trash2, XCircle, School } from "lucide-react";
...
export default function ManageClassesPage() {
  ...
  const entityApiPrefix = "classes";
  const entityIcon = School;
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder={`e.g., ${entityName === 'Class' ? '11th Science' : entityName === 'Subject' ? 'Physics' : 'Thermodynamics'}`}
                required
              />
            </div>
          </CardContent>
